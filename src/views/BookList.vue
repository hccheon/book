          ...
          <div class="container">
                ...
                <div class="col-lg-3 col-mid-6">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          ...
                          <router-link to="/detail" class="btn btn-primary">Add Item</router-link>
                        </div>
                    </div>
                </div>
              </div>
              ...
              <table class="table table-hover mt-3">
                ...
                <tbody>
                  <tr>
                    <th scope="row">1</th>
                    <td><img src="http://image.yes24.com/goods/103336234/XL" alt="책표지" width="25px" height="25px"></td>
                    <td>9791158391508</td>
                    <td>한 권으로 배우는 Vue.js 3</td>
                    <td>
                  ...
                  <tr>
                    <th scope="row">2</th>
                    <td><img src="http://image.yes24.com/goods/101926719/XL" alt="책표지" width="25px" height="25px"></td>
                    <td>9791158391507</td>
                  ...
                  <tr>
                    <th scope="row">3</th>
                    <td><img src="http://image.yes24.com/goods/58206961/XL" alt="책표지" width="25px" height="25px"></td>
                    <td>9791158391506</td>
                    <td>Do it! Vue.js 입문</td>
                    <td>
                      <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                        <router-link to="/detail">
                          <button class="btn btn-warning me-md-2" type="button">
